...
class FormInput extends Component {
  ...
  render() {
    ...
    inputClass = `${inputClass || (type == "checkbox" ? "" : "col-md-9")} ${
      type == "select" ? " pl-0 pr-0" : " form-control"
    }`;
    ...
    return (
      <div className={parentClass}>
        ...
        {!valid || requiredErr.msg ? (
          <label
            className={`${inputClass} form-label-err`}
            name={CONSTANTS.LABEL_VALID_ERROR_NAME}>
            {requiredErr.msg ? requiredErr.msg : errorLabel}
          </label>

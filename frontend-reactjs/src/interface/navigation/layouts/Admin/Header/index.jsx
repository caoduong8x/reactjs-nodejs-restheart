...
class Header extends Component {
  ...
  render() {
    ...
    let name = "";
    if (!cmFunction.isEmpty(LoginRes)) name = this.props.LoginRes.user.name;
    return (
      <nav
        ref="PageHeaderTop"
        className="sb-topnav navbar navbar-expand navbar-dark bg-dark page-header-top">
        <button
        ...
        <ul className="navbar-nav ml-auto ml-md-0">
          <li className="nav-item dropdown">
            ...
            <div
              ...
              <Link to="/ca-nhan" className="dropdown-item">
                Cá nhân
              </Link>
              <Link to="/mat-khau" className="dropdown-item">
                Đổi mật khẩu
              </Link>
              <div className="dropdown-divider"></div>
              <button onClick={this._handleLogout} className="dropdown-item">
                Đăng xuất
              </button>
            </div>
          </li>
